											...
											<tbody>
												...
												@foreach ($invoices as $value)
													...
													<tr>
														...
														<td>{{$value->product}}</td>
														<td>
															<a href="{{ url('InvoicesDetails') }}/{{ $value->id }}">{{ $value->sections->section_name }}</a>
														</td>
														...
														<td>{{$value->total}}</td>
														<td>
															@if ($value->value_status == 1)
																<span class="text-success">{{ $value->status }}</span>
															@elseif($value->value_status == 2)
																<span class="text-danger">{{ $value->status }}</span>
															@else
																<span class="text-warning">{{ $value->status }}</span>
															@endif
														</td>
														<td>{{$value->note}}</td>
														<td>
																...
																<div class="dropdown-menu tx-13">
																	@can('تعديل الفاتورة')
																		<a class="dropdown-item"
																			href=" {{ url('edit_invoice') }}/{{ $value->id }}">تعديل
																			الفاتورة</a>
																	@endcan
				
																	@can('حذف الفاتورة')
																		<a class="dropdown-item" href="#" data-invoice_id="{{ $value->id }}"
																	...
																	@can('تغير حالة الدفع')
																		<a class="dropdown-item"
																			href="{{ URL::route('Status_show', [$value->id]) }}"><i
																	...
																	@can('طباعةالفاتورة')
																		<a class="dropdown-item" href="Print_invoice/{{ $value->id }}"><i
