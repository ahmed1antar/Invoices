								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">عدد الفواتير :</p>
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">{{\App\Models\Invoice::count()}}</p>
										</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{number_format(\App\Models\Invoice::where('status','غير مدفوعه')->sum('total'),2)}}
											</h4>
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">عدد الفواتير :</p>
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">{{\App\Models\Invoice::where('status','غير مدفوعه')->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">عدد الفواتير :</p>
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">{{\App\Models\Invoice::where('status','مدفوعة')->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">عدد الفواتير :</p>
											<p class="mb-0 tx-12 text-white op-7" style="display: inline-block">{{\App\Models\Invoice::where('status','مدفوعة جزئيا')->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
